  ...
  ru: {
    ...
    benefits: {
      ...
      cards: [
        ...
        { title: "Кастомная интеграция", description: "Создание агентов под ваши процессы и инфрастуктуру." },
    ...
    process: {
      ...
      steps: [
        ...
        { number: "04", title: "Постоянная оптимизация", text: "Наши системы способны дообучаться, становясь все более эффективнее со временем." },
      ]
    },
    demos: {
      title: "Демо-проекты",
    ...
    cta: {
      ...
      subtitle: "Присоединяйтесь ко множеству компании, которые трансформировали свои операции с помощью AI-агентов.",
    },
    footer: {
      desc: "Автоматизация бизнеса нового поколения с помощью нейронных агентов и интеграции когнических рабочих процессов.",
      product: "Продукт",
      company: "Компания",
      agents: "Агенты",
...
- Отвечайте кратко и по существу на русском языке.`,
    ...
    auth: {
      ...
      loading: "Вход...",
      defaultCreds: "Параметры входа по умолчанию: admin / admin",
    }
  },
  en: {
    nav: {
...
- Respond concisely and to the point in English.`,
    ...
    auth: {
      ...
      loading: "Signing in...",
      defaultCreds: "Default login credentials: admin / admin",
    }
  }
};
